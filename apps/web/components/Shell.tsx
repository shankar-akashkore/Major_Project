...
import { getBudget, getConfig, type AppConfig } from "@/lib/api.ts";
...
const MODE_TONE: Record<string, Tone> = { mock: "warn", replay: "info", live: "bad" };
      ...
      <div className="mx-auto max-w-6xl px-5 py-6">
        <header className="mb-6 border-b border-zinc-800 pb-4">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              {mode ? (
                <Badge tone={MODE_TONE[mode] ?? "neutral"} title={MODE_MEANING[mode]}>
                  {mode} mode
                </Badge>
              ) : null}
