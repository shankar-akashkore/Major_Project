...
_IMAGE_BUILDERS: dict[str, type[ImageProvider]] = {"mock": MockImageProvider}
_VIDEO_BUILDERS: dict[str, type[VideoProvider]] = {"mock": MockVideoProvider}
...
_PLANNED_VIDEO = {"kling-3", "seedance-2.5", "ltx-video", "wan-2.1-i2v", "veo-3.1-fast"}
...
def get_image_provider(
    ...
    return builder(storage)  # type: ignore[call-arg]
